...
with col_input2:
    ...
    default_actions = pd.DataFrame([
        {"計上種別": "売上高", "プラン名": "新規販路拡大", "月間効果額": 2000, "効果開始月": start_month + relativedelta(months=6)},
    ])
...
for m in range(months):
    ...
    action_rev, action_cos, action_sga = 0, 0, 0
    plan_impacts = {}
    ...
    # 現預金月商倍率
    cash_sales_ratio = current_cash / total_rev if total_rev > 0 else 0
